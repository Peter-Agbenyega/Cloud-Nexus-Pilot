...
export default function ContactPage() {
  return (
    <>
      <PageHero eyebrow="Contact" title="Ask about products, bundles, or partner opportunities." description="Use this route for general market support, bundle requests, or implementation service inquiries." />
      <section className="section-shell grid gap-8 pb-16 lg:grid-cols-[1fr_320px]">
        <ContactForm submitLabel="Send message" context="We need help choosing the right templates and bundles for our cloud team." />
